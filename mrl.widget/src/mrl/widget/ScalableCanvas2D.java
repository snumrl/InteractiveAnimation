...
public abstract class ScalableCanvas2D extends Composite implements PaintListener, MouseListener, MouseWheelListener, MouseMoveListener{
	...
	protected abstract boolean onMouseDown(Point2d p, MouseEvent e);
	protected abstract boolean onMouseMove(Point2d p, MouseEvent e);
	protected abstract boolean onMouseUp(Point2d p, MouseEvent e);
	protected abstract boolean onMouseDoubleClick(Point2d p, MouseEvent e);
	protected abstract boolean onMouseScrolled(Point2d p, MouseEvent e);
	protected abstract Rectangle getContentBoundary();
	protected abstract void onBoundarySelection(Rectangle2d boundary, MouseEvent e);
...
//		});
	...
	public static void drawArrow(GC gc, double x1, double y1, double x2, double y2, double offset1, double offset2) {
		...
		gc.drawLine(round(x1), round(y1), round(x2 - direction.x*headOffset/2), round(y2 - direction.y*headOffset/2));
