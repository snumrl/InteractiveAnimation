...
//	public static PointIKSolver_CMU ikSolver;
	static{
...
//		ikSolver = new PointIKSolver_CMU(mData.skeletonData, mData.motionList.get(0));
	}
...
//			double distLimit = BallTrajectoryGenerator.BALL_RADIUS*2;
	...
	public PositionResultMotion update(double[] data){
		...
		if (MotionDataConverter.useOrientation){
			Motion mMotion = MotionDataConverter.dataToMotionByOri(data);
