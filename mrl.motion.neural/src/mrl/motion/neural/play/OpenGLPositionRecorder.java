...
public class OpenGLPositionRecorder extends Module{
	
	
	private RuntimeController c;
	private boolean isStop = false;
	
	private ArrayList<PositionResultMotion> motionList = new ArrayList<PositionResultMotion>();
	private ArrayList<Point2d> targetList = new ArrayList<Point2d>();

	
	public OpenGLPositionRecorder(RuntimeController c) {
		this.c = c;
	}
	...
	public static void run(RuntimeController c){
		MainApplication.run(new OpenGLPositionRecorder(c));
	}
}
