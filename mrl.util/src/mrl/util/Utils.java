...
public class Utils {
	...
	public static void copyFolder(File source, File target){
		...
		for (File f : source.listFiles()){
			copyTextFile(f, new File(target.getAbsolutePath() + "\\" + f.getName()));
		}
	}
	...
	public static <E> E[] toArray(List<E> list){
		return toArray(list, (Class<E>)list.get(0).getClass());
	}
	
	@SuppressWarnings("unchecked")
	public static <E> E[] toArray(List<E> list, Class<E> c){
		try {
